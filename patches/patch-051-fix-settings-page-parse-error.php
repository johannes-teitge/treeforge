...
/**
 * TreeForge CMS - Patch 051
 * Fix Settings Page Parse Error
 *
 * Problem:
 * Patch 050 hat public/admin/settings/index.php beschädigt.
 *
 * Fehler:
 * Parse error: unexpected token "<", expecting end of file
 *
 * Fix:
 * Settings-Seite wird vollständig und sauber neu geschrieben.
 * Enthält:
 * - General
 * - Languages
 * - Storage
...
return function (string $root, callable $log): void {
    ...
    $log('Patch 051 Fix Settings Page Parse Error gestartet');
...
PHP);
    ...
    $write($root . '/docs/treeforge/41-fix-settings-page-parse-error.md', <<<'MD'
# Fix Settings Page Parse Error
...
MD);
    ...
    $log('Patch 051 Fix Settings Page Parse Error fertig');
};
