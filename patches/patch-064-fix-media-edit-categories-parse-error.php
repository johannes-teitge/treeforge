...
/**
 * TreeForge CMS - Patch 064
 * Fix Media Edit Categories Parse Error
 *
 * Problem:
 * Patch 063 hat public/admin/media/edit.php beschädigt.
 *
 * Fix:
 * edit.php wird vollständig sauber neu geschrieben:
 * - MediaRepository
 * - MediaReplaceService
...
return function (string $root, callable $log): void {
    ...
    $log('Patch 064 Fix Media Edit Categories Parse Error gestartet');
...
PHP);
    ...
    $write($root . '/docs/treeforge/54-fix-media-edit-categories-parse-error.md', <<<'MD'
# Fix Media Edit Categories Parse Error
...
MD);
    ...
    $log('Patch 064 Fix Media Edit Categories Parse Error fertig');
};
